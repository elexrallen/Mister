...
- **Once y capitán** (siempre lo primero, es lo único que puntúa): huecos sin
  cubrir, dudas pendientes de confirmar y cambio de capitán con su motivo.
...
- **Mercado según fase**: fichar y listar ventas en la ventana de compra, última
  llamada en confirmación, y freno explícito en víspera y día de partido.
...
4. Después de la jornada, revisa el histórico de puntos (`history/`) para ver si
   las decisiones del ciclo anterior acertaron.
